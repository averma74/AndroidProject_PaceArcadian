...
public class TradeRequestItem {
    ...
    public TradeRequestItem(String mMyTitle, String mMyDescription, String mMyCategory, String mMyUserId,
                            String mOfferedTitle, String mOfferedDescription, String mOfferedCategory,
    ...
    public String getmMyTitle() {
        return mMyTitle;
    }

    public String getmMyDescription() {
    ...
    public String getmOfferedTitle() {
        return mOfferedTitle;
    }

    public String getmOfferedDescription() {
